...
namespace gui
{
	partial class Auth
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "enter trial key";
			// 
			// textBox1
			// 
			...
			this.linkLabel1.Text = "get a key";
			this.linkLabel1.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.linkLabel1_LinkClicked);
			// 
			// submit
			// 
			this.submit.Location = new System.Drawing.Point(21, 51);
			...
			this.status.Location = new System.Drawing.Point(182, 51);
			this.status.Name = "status";
			this.status.Size = new System.Drawing.Size(39, 13);
			this.status.TabIndex = 4;
			this.status.Text = "waahh";
			// 
			// Auth
			// 
